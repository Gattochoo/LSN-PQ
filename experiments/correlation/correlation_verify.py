...
Independent adjudication of   (): exact sympLPN correlations.
...
From-scratch checks (exact Fractions):
  ...
  (2) the sigma-twist: the proof lemma "sum_{v in L}(-1)^{<1_S,v>} =
...
def main():
    ok = True
    print("=" * 76)
    print("253-   — sympLPN exact correlations: from-scratch check")
    print("=" * 76)
