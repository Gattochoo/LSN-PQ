...
fn profile_spec(profile: &str) -> ProfileSpec {
    let mut spec = ProfileSpec {
        default_output: PathBuf::from(
            "experiments/183--lsn-ref-n2-paper-r7-public-preflight.json",
),
        experiment: "-lsn-ref-n2-paper-r7-public-preflight",
        config: ToyPublicPreflightScanConfig {
            params: ToyKemParams {
                n: 2,
                sample_count: 2048 * 7,
    ...
    match profile {
        ...
        "n2-paper-r7-public-preflight-wrong16" => {
            spec.default_output = PathBuf::from(
                "experiments/184--lsn-ref-n2-paper-r7-public-preflight-wrong16.json",
);
            spec.experiment = "-lsn-ref-n2-paper-r7-public-preflight-wrong16";
