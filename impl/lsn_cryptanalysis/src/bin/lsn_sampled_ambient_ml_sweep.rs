...
fn main() {
    ...
    let experiment = match (args.candidate_cap.is_some(), args.streaming) {
        (false, false) => "-p2-sampled-ambient-size-candidate-ml",
        (true, false) => "-p2-capped-ambient-size-candidate-ml",
        (false, true) => "-p2-streaming-ambient-size-candidate-ml",
        (true, true) => "-p2-capped-streaming-ambient-size-candidate-ml",
    };
